  ...
  return (
    <div className="pt-24 pb-20 bg-white min-h-screen">
      ...
      <div className="container-app max-w-4xl mb-8">
        <Link to="/blog" className="flex items-center gap-2 text-sm text-surface-500 hover:text-surface-900 transition-colors">
      ...
      <article className="container-app max-w-4xl">
        ...
        <div className="rounded-2xl bg-navy-800 p-8 text-white text-center mb-12">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link to="/contact" className="btn-ghost text-white hover:bg-white/10 border border-white/20">
              Talk to an Expert
            </Link>
          </div>
        </div>
        ...
        {related.length > 0 && (
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {related.map(b => (
                <Link key={b.id} to={`/blog/${b.slug}`} className="card card-hover block group overflow-hidden">
