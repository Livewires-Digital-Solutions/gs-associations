          ...
          >
            ...
            <motion.div variants={itemVariants} className="flex flex-wrap gap-2">
              {['Gachibowli', 'Jubilee Hills', 'Kondapur', 'Banjara Hills', 'Kokapet', 'Narsingi'].map(loc => (
                <button
                  key={loc}
                  onClick={() => navigate(`/properties?location=${loc}`)}
      ...
      <section className="section bg-white">
        <div className="container-app">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link to="/properties" className="hidden md:flex items-center gap-2 text-navy-700 font-semibold text-sm hover:text-navy-900 transition-colors">
              View All Properties
            ...
            <div className="relative z-10 p-10 md:p-16 flex flex-col md:flex-row items-center gap-12">
              <div className="flex-1">
                ...
                <div className="flex flex-wrap gap-4">
                  <Link to="/loans" className="btn-gold">
      ...
      <section className="section bg-surface-50">
        <div className="container-app">
          <div className="flex items-end justify-between mb-12">
            ...
            <Link to="/blog" className="hidden md:flex items-center gap-2 text-navy-700 font-semibold text-sm hover:text-navy-900 transition-colors">
              All Articles
              <ChevronRight className="w-4 h-4" />
            </Link>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {latestBlogs.map((blog, i) => (
              <motion.div
                ...
                transition={{ delay: i * 0.1 }}
              >
                <Link to={`/blog/${blog.slug}`} className="card card-hover block group overflow-hidden">
        ...
        <div className="container-app relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link to="/contact" className="btn-ghost text-white hover:bg-white/10 border border-white/20 text-base px-8 py-4">
                Talk to an Expert
              </Link>
            </div>
          </motion.div>
