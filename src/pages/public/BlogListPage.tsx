      ...
      <div className="container-app">
        ...
        {featured && category === 'All' && !search && (
          <motion.div
            ...
            className="mb-12"
          >
            <Link to={`/blog/${featured.slug}`} className="card card-hover block group overflow-hidden">
        ...
        {filtered.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filtered.map((blog, i) => (
              ...
              >
                <Link to={`/blog/${blog.slug}`} className="card card-hover block group overflow-hidden h-full flex flex-col">
