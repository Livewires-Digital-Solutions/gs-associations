  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        ...
        <Link to="/admin/leads" className="btn-primary text-sm">
          View All Leads
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card overflow-hidden">
          <div className="p-5 border-b border-surface-100 flex items-center justify-between">
            ...
            <Link to="/admin/leads" className="text-xs text-navy-700 font-medium hover:text-navy-900">View all →</Link>
          </div>
        ...
        <div className="card overflow-hidden">
          <div className="p-5 border-b border-surface-100 flex items-center justify-between">
            ...
            <Link to="/admin/tracking" className="text-xs text-navy-700 font-medium hover:text-navy-900">View tracking →</Link>
          </div>
          <div className="p-5">
            <ResponsiveContainer width="100%" height={220}>
