    ...
    <div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {statCards.map((card, i) => (
          ...
          >
            <Link href={card.link} className="card p-5 block hover:border-navy-200 transition-all group">
      ...
      {recentlyViewed.length > 0 && (
        <section className="mb-10">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="/dashboard/history" className="text-sm text-navy-700 font-medium hover:text-navy-900 flex items-center gap-1">
      ...
      {savedProperties.length > 0 && (
        <section className="mb-10">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link href="/dashboard/saved" className="text-sm text-navy-700 font-medium hover:text-navy-900 flex items-center gap-1">
              View All <ArrowRight className="w-3.5 h-3.5" />
            </Link>
          </div>
      ...
      <section>
        ...
        {recommended.length > 0 ? (
          ...
          <div className="card p-8 text-center">
            ...
            <Link href="/dashboard/profile" className="btn-primary text-sm">Complete Profile</Link>
          </div>
        )}
      </section>
    </div>
